...
const leaveIntoObject = (leave) => {
  ...
  const statusMap = {
    [Leave.status_new()]:           'Εκκρεμεί',
    [Leave.status_approved()]:      'Εγκρίθηκε',
    [Leave.status_rejected()]:      'Απορρίφθηκε',
    [Leave.status_pended_revoke()]: 'Εκκρεμής ανάκληση',
    [Leave.status_canceled()]:      'Ακυρώθηκε',
  };
